...
`
const data = await graphQLClient.request(headerquery)


  return {
    props: {
      headerlogos : data.headerSectionCollection.items,
    },
    revalidate: 60,
  }
}
                ...
                <div className="border-b border-gray-200">
                  <div className="h-16 flex items-center px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="ml-4 flex lg:ml-0">
                      <a href="/">
         <div key="header" className="relative bg-black overflow-hidden">
           <div className="container mx-auto">
         <div className="md:flex items-center">
          <Image
                src="https://images.ctfassets.net/ei8z56ft9sxn/4mddNDagdfZWHEV2rEJYdf/705922bac14629c10e0780e46d985cc7/fifa-logo.png?h=250" 
                      ...
                      <div className="h-full flex space-x-8">
                                ...
                                <div className="relative flex">
                                  <Popover.Button
                                    className={classNames(
                                      open
                                        ? 'text-white hover:text-white uppercase'
                                        : 'border-transparent text-white hover:text-white uppercase',
                                    ...
                                    <div className="relative bg-white">
                                      <div className="max-w-7xl mx-auto px-8">
                                        <div className="grid grid-cols-2 gap-y-10 gap-x-8">
                                          ...
                                          <div className="row-start-1 grid grid-cols-3 gap-y-10 gap-x-8 text-sm pt-5 pb-5">
                                            {category.sections.map((section) => (
                                              <div key={section.name}>
                        ...
                        {navigation.pages.map((page) => (
                          <a
                            key={page.name}
                            href={page.href}
                            className="flex items-center text-sm font-medium text-white hover:text-white uppercase"
                          >
                            {page.name}
                          </a>
                        ))}
